	...
	return (
		<section className="experience" id="experience">
			<div className="max-width">
				...
				<div className="experience-content">
					...
					<div className="column right">
						<div className="text">
							...
							<span>New Delhi | August 2021 - present</span>
						</div>
						<ul>
							<li>
							...
							<li>Responsible for handling the Database as well as the Back End Development</li>
						</ul>
					</div>
				</div>
				<br />
				...
				<div className="experience-content">
					<div className="column right">
						<div className="text"><span><h2>Problem to be Solved :</h2></span></div>
						<ul>
				...
				<div className="experience-content">
					...
					<div className="column right">
						<div className="text"><span><h2>Technology used :</h2></span></div>
						<ul>
				...
				<div className="experience-content">
					<div className="column right">
						<div className="text"><span><h2>Noteworthy Features :</h2></span></div>
						<ul>
